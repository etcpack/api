...
var uiSearch =__etcpack__scope_args__.default;
    ...
    let pages = {
        begin: () => window.__etcpack__getLazyBundle('./build/main@v0.2.2-bundle1.js','24'),
        api: () => window.__etcpack__getLazyBundle('./build/main@v0.2.2-bundle2.js','25')
    };
