...
var fixedScroll =__etcpack__scope_args__.default;
    ...
    let pages = {
        basic: () => window.__etcpack__getLazyBundle('./build/main@v0.2.2-bundle3.js','36'),
        api: () => window.__etcpack__getLazyBundle('./build/main@v0.2.2-bundle4.js','37')
    };
